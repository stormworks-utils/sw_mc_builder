...
from sw_mc_lib.Components import PropertyNumber, PropertySlider, PropertyText, PropertyToggle, PropertyDropdown
...
PROPERTIES = (PropertyNumber, PropertySlider, PropertyText, PropertyToggle, PropertyDropdown)
